...
namespace RabbitMQAddWatermarksToImages.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,ImageName")] Product product,IFormFile ImageFile)
        {
            ...
            if (!ModelState.IsValid || ImageFile is { Length: < 100 })
            {
                return View(product);
            }
            else
            {
                ...
                string imagePath = Path.Combine(Directory.GetCurrentDirectory(),"wwwroot/images",randomImageName);
